...
import com.auralis.player.home.list.AlbumListFragment
import com.auralis.player.home.list.ArtistListFragment
import com.auralis.player.home.list.AudiobookListFragment
import com.auralis.player.home.list.GenreListFragment
import com.auralis.player.home.list.PlaylistListFragment
import com.auralis.player.home.list.SongListFragment
import com.auralis.player.home.tabs.NamedTabStrategy
import com.auralis.player.list.ListViewModel
import com.auralis.player.list.SelectionFragment
...
import com.auralis.player.ui.FadingToolbarOffsetListener
import com.auralis.player.util.collect
import com.auralis.player.util.collectImmediately
import com.auralis.player.util.dampen
            ...
            R.id.action_sort -> {
                ...
                val directions =
                    when (homeModel.currentTabType.value) {
                        ...
                        // Audiobooks expose their own controls and do not use Music sorting.
                        MusicType.AUDIOBOOKS -> return true
                    }
