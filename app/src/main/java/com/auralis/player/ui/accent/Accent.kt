...
private val accentThemes =
    intArrayOf(
        R.style.Theme_Auralis_Red,
        R.style.Theme_Auralis_Pink,
        R.style.Theme_Auralis_Purple,
        R.style.Theme_Auralis_DeepPurple,
        R.style.Theme_Auralis_Indigo,
        R.style.Theme_Auralis_Blue,
        R.style.Theme_Auralis_DeepBlue,
        R.style.Theme_Auralis_Cyan,
        R.style.Theme_Auralis_Teal,
        R.style.Theme_Auralis_Green,
        R.style.Theme_Auralis_DeepGreen,
        R.style.Theme_Auralis_Lime,
        R.style.Theme_Auralis_Yellow,
        R.style.Theme_Auralis_Orange,
        R.style.Theme_Auralis_Brown,
        R.style.Theme_Auralis_Grey,
        R.style.Theme_Auralis_App, // Dynamic colors are on the base theme
    )

private val accentBlackThemes =
    intArrayOf(
        R.style.Theme_Auralis_Red_Black,
        R.style.Theme_Auralis_Pink_Black,
        R.style.Theme_Auralis_Purple_Black,
        R.style.Theme_Auralis_DeepPurple_Black,
        R.style.Theme_Auralis_Indigo_Black,
        R.style.Theme_Auralis_Blue_Black,
        R.style.Theme_Auralis_DeepBlue_Black,
        R.style.Theme_Auralis_Cyan_Black,
        R.style.Theme_Auralis_Teal_Black,
        R.style.Theme_Auralis_Green_Black,
        R.style.Theme_Auralis_DeepGreen_Black,
        R.style.Theme_Auralis_Lime_Black,
        R.style.Theme_Auralis_Yellow_Black,
        R.style.Theme_Auralis_Orange_Black,
        R.style.Theme_Auralis_Brown_Black,
        R.style.Theme_Auralis_Grey_Black,
        R.style.Theme_Auralis_Black, // Dynamic colors are on the base theme
    )
