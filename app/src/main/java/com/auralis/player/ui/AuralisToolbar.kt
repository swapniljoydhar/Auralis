...
import com.auralis.player.databinding.ViewToolbarBinding
...
constructor(
    ...
    private fun createActionButtonContext(itemId: Int): Context {
        val themeOverlayRes =
            when (itemId) {
                R.id.action_play -> R.style.ThemeOverlay_Auralis_IconButton_Style_Small_Secondary
                R.id.action_shuffle -> R.style.ThemeOverlay_Auralis_IconButton_Style_Small_Primary
                else -> 0
            }
