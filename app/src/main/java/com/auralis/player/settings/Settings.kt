...
interface Settings<Listener> {
    /**
     * Migrate any settings fields from older versions into their new counterparts. Implementations
     * that have no migration work intentionally use this no-op default.
     */
    fun migrate() {}
