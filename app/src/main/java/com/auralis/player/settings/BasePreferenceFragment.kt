...
import com.auralis.player.settings.ui.IntListPreference
import com.auralis.player.settings.ui.IntListPreferenceDialog
import com.auralis.player.settings.ui.PreferenceHeaderItemDecoration
...
abstract class BasePreferenceFragment(@XmlRes private val screen: Int) :
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<AuralisToolbar>(R.id.preferences_toolbar).apply {
