...
import com.auralis.player.playback.replaygain.ReplayGainMode
import com.auralis.player.playback.replaygain.ReplayGainPreAmp
...
class PlaybackSettingsImpl @Inject constructor(@ApplicationContext context: Context) :
    ...
    private companion object {
        const val OLD_KEY_LIB_MUSIC_PLAYBACK_MODE = "auralis_library_playback_mode"
        const val OLD_KEY_DETAIL_MUSIC_PLAYBACK_MODE = "auralis_detail_playback_mode"
    }
}
