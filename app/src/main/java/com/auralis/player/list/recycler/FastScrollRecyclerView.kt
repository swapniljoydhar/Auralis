...
import com.auralis.player.util.isRtl
import com.auralis.player.util.isUnder
 ...
 * Hai Zhang's AndroidFastScroll but slimmed down for Auralis and with a couple of enhancements.
 *
 ...
 * - Use modified Auralis resources instead of AFS resources
...
constructor(context: Context, attrs: AttributeSet? = null, @AttrRes defStyleAttr: Int = 0) :
    AuralisRecyclerView(context, attrs, defStyleAttr) {
    // Thumb
